...
<hr>
<p>
Results-driven Software Engineer with over 15 years of experience specializing in full-stack web 
development, Content Management Systems, and Learning Management Systems. Proven track 
record of leading technical teams and delivering high-quality software solutions across various 
industries. Proficient in PHP (Laravel, CodeIgniter), MySQL, PostgreSQL, HTML, HTML5, CSS, 
Bootstrap, JavaScript (jQuery, Ajax, Angular, React, Ionic), Agile methodologies, Git, CI/CD, GitHub 
Actions, AWS, Docker, Apache, and Linux. Highly technical with a strong commitment to continuous 
...
<ul>
  ...
  <li>Process improvement programs</li>
